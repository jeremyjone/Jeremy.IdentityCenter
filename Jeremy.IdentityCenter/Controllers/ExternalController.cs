...
namespace Jeremy.IdentityCenter.Controllers
{
    ...
    public class ExternalController : Controller
    {
        ...
        private async Task<(IdcIdentityUser user, string provider, string providerUserId, IEnumerable<Claim> claims)>
        ...
        private async Task<IdcIdentityUser> AutoProvisionUserAsync(string provider, string providerUserId, IEnumerable<Claim> claimList)
        {
            var claims = claimList as Claim[] ?? claimList.ToArray();
