...
{
    public class IdcConfigurationDbContext : ConfigurationDbContext<IdcConfigurationDbContext>, IIdcConfigurationDbContext
    {
        public IdcConfigurationDbContext(DbContextOptions<IdcConfigurationDbContext> options,
